...
class DashboardServer implements MessageComponentInterface
{
    ...
    public function __construct($conn)
    {
        ...
        $this->dashboards = [];
        $this->conn = $conn;
        $this->log("🚀 Servidor WebSocket iniciado en ws://localhost:8081");
    }
    ...
    public function onMessage(ConnectionInterface $from, $msg)
    {
        ...
        switch ($data['accion'] ?? $data['tipo'] ?? '') {
            ...
            // ========================================
            case 'registro_dashboard':
                $from->id_equipo = $data['id'] ?? 'Desconocido';
                echo "💻 Dashboard registrado: {$from->id_equipo}\n";
            ...
            case 'registro_cliente':
                ...
                $from->idCliente = $data['id'] ?? 'Desconocido';
